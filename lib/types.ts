...
export interface ParentLocation { // ParentSlot -> ParentLocation
...
export interface Slot { // Slot interface name remains Slot for consistency, but referred to as 'Location' in UI/variables
